...
namespace LW.NSocket.Client
{
    ...
    public class Request<TResponse> : SocketBase.Packet where TResponse : Response.IResponse
    {
        ...
        public Request(int seqID, string uid, string cmdName, byte[] payload, Action<Exception> onException, Action<TResponse> onResult)
            : this(null, seqID, uid, cmdName, payload, onException, onResult)
        {
        }
        /// <summary>
        /// new
        ...
        public Request(byte[] consistentKey, int seqID, string uid, string cmdName, byte[] payload, Action<Exception> onException, Action<TResponse> onResult)
            : base(payload)
        {
