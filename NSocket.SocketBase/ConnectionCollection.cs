...
namespace LW.NSocket.SocketBase
{
    ...
    public sealed class ConnectionCollection
    {
        ...
        public KeyValuePair<long, IConnection> Get(IPEndPoint remoteEndPoint)
        {
            return _dic.FirstOrDefault(c => (c.Value.RemoteEndPoint.Address.Equals(remoteEndPoint.Address)));
        }
        /// <summary>
        /// to array
        /// </summary>
