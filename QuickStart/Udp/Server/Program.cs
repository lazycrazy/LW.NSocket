...
namespace Server
{
    class Program
    {
        ...
        {
            var server = new LW.NSocket.Server.UdpServer<MyCmdInfo>(9500, new UdpProtocol(), new UdpService());
            server.Start();
            Console.ReadLine();
        }
    }

    public class UdpService : LW.NSocket.Server.IUdpService<MyCmdInfo>
    {
        public void OnReceived(LW.NSocket.Server.UdpSession session, MyCmdInfo cmdInfo)
        {
            Console.WriteLine(cmdInfo.CmdName);
        }

        public void OnError(LW.NSocket.Server.UdpSession session, Exception ex)
        {
            Console.WriteLine(ex.ToString());
        }
    }

    public class UdpProtocol : LW.NSocket.Server.Protocol.IUdpProtocol<MyCmdInfo>
    {
    ...
    public class MyCmdInfo : LW.NSocket.Server.Command.ICommandInfo
    {
        /// <summary>
        /// new
        /// </summary>
